...
import { IPayload, ITokens } from '../auth/interfaces/token.interface';
...
export class AuthGraphqlService {
  ...
  async register(dto: RegisterInput): Promise<ITokens> {
  ...
  async login(dto: LoginInput): Promise<ITokens> {
